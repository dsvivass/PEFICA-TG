...
\draw (6.000000,0.000000)--(9.000000,0.000000) node[nudo] {2}; 
\draw (9.000000,0.000000)--(12.000000,0.000000) node[nudo] {3}; 
\end{scope} 
% dibujar nudos 
\tikzstyle{nudo}=[fill=black,above right]; 
\def \r{0.05}; 
\begin{scope}[nudo] 
\fill (6.000000,0.000000) circle (\r) node {1}; 
\fill (9.000000,0.000000) circle (\r) node {2}; 
\fill (12.000000,0.000000) circle (\r) node {3}; 
\fill (0.000000,0.000000) circle (\r) node {4}; 
\end{scope} 
% dibujar apoyos 
